---
title: ACT House Starter | React Native/Expo starter
...
hero:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: Hire Us
      link: https://acthouse.com/contact?utm_source=starter.acthouse.com
      icon: external
      variant: secondary
---
...
[Hire Us](https://acthouse.com/contact?utm_source=starter.acthouse.com)
