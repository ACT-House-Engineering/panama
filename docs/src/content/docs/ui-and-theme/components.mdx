...
![Create component](https://github.com/ACT-House-Engineering/panama/assets/11137944/ca84555f-12b7-4048-98b8-3c8391bd9918)
:::
...
For form handling with TanStack Form, use the Input component directly with form.Field. Read more about Handling Forms [here](../forms/).
...
For form handling with TanStack Form, use the Select component directly with form.Field. Read more about Handling Forms [here](../forms/).
