...
<CodeBlock file="./src/features/auth/components/login-form.tsx" />
...
First, let's create a new file called `login-form.test.tsx` in the `src/features/auth/components` directory. Then, add the following code to it:

<CodeBlock file="./src/features/auth/components/login-form.test.tsx" />
...
![GitHub action output](https://github.com/ACT-House-Engineering/panama/assets/11137944/081896b2-bf74-490b-9ad5-da8e2bbc5c88)
